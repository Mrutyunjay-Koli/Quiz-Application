...
public class Quiz extends JFrame implements ActionListener {
   ...
   Quiz(String name) {
      this.name = name;
      this.setBounds(50, 0, 1140, 850);
      this.getContentPane().setBackground(Color.WHITE);
      this.setLayout((LayoutManager)null);
      ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/quiz.jpg"));
      JLabel image = new JLabel(i1);
      image.setBounds(0, 0, 1140, 370);
      this.add(image);
      this.qno = new JLabel("1");
      this.qno.setBounds(100, 390, 50, 30);
      this.qno.setFont(new Font("Tahoma", 0, 20));
      this.add(this.qno);
      this.question = new JLabel("This is question");
      this.question.setBounds(150, 390, 900, 30);
      this.question.setFont(new Font("Tahoma", 0, 20));
      ...
      this.opt1 = new JRadioButton("Option 1");
      this.opt1.setBounds(170, 430, 700, 30);
      this.opt1.setBackground(Color.WHITE);
      this.opt1.setFont(new Font("Dialog", 0, 20));
      this.add(this.opt1);
      this.opt2 = new JRadioButton("Option 1");
      this.opt2.setBounds(170, 470, 700, 30);
      this.opt2.setBackground(Color.WHITE);
      this.opt2.setFont(new Font("Dialog", 0, 20));
      this.add(this.opt2);
      this.opt3 = new JRadioButton("Option 1");
      this.opt3.setBounds(170, 510, 700, 30);
      this.opt3.setBackground(Color.WHITE);
      this.opt3.setFont(new Font("Dialog", 0, 20));
      this.add(this.opt3);
      this.opt4 = new JRadioButton("Option 1");
      this.opt4.setBounds(170, 550, 700, 30);
      ...
      this.next.setBounds(870, 440, 200, 40);
      ...
      this.lifeline.setBounds(870, 520, 200, 40);
      ...
      this.submit.setBounds(870, 600, 200, 40);
   ...
   public void paint(Graphics g) {
      ...
      if (timer > 0) {
         g.drawString(time, 875, 460);
      } else {
         g.drawString("Times up!!", 920, 460);
      }
